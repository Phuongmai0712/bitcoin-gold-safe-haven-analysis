...
The portfolio results show this particularly clearly: a fixed 10% Bitcoin allocation increased variance by 16.16%, while dynamic gold reduced variance by approximately 36%. :contentReference\[oaicite:0]{index=0}
...
The final sample contains \*\*1,315 daily observations from 5 January 2021 to 31 March 2026\*\*. :contentReference\[oaicite:1]{index=1}
